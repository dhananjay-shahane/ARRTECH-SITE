          ...
          <div className="relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-8 min-h-[280px] md:min-h-[340px]">
            {/* Left - Content */}
              <div className="flex flex-col justify-center px-8 md:px-12 lg:px-16 py-6">
                ...
                <p className="text-base md:text-lg text-white/90 mb-8 max-w-lg font-light drop-shadow-sm">
                  Join 500+ enterprises leveraging ARRTECH APPS AND DATA SOLUTIONS for next-gen software and digital platform solutions across India.
                </p>
