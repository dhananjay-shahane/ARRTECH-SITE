...
export const HeroCopy: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen bg-white py-12 flex flex-col items-center justify-center overflow-hidden">
      
      {/* Main Background */}
      <div className="absolute inset-0 bg-white pointer-events-none" />

      <div className="w-full max-w-[1600px] mx-auto px-6 relative z-10 flex flex-col items-center text-center">
        ...
        <motion.div
          ...
          className="w-full max-w-none mx-auto rounded-3xl bg-white border border-slate-200 shadow-xl p-6 md:p-12 lg:p-14 relative overflow-visible"
        >
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-x-16 items-stretch">
            ...
            <div className="lg:col-span-4 flex flex-col justify-between gap-10">
              ...
              <div 
                ref={webDevRef}
                className="rounded-2xl border border-slate-200/70 bg-white p-3 shadow-lg flex flex-col min-h-[220px] max-w-[340px] w-full mx-auto relative hover:-translate-y-1.5 hover:shadow-2xl transition-all duration-300"
              >
                ...
                {/* GIF Container */}
                <div className="flex-1 w-full rounded-xl overflow-hidden relative bg-white flex items-center justify-center p-1">                  <img 
            ...
            <div className="lg:col-span-4 flex flex-col justify-between items-center gap-10 min-h-[500px]">
              ...
              >
                ...
                <div className="flex flex-col items-center justify-center select-none z-10">                  <img 
                    src="/img/thunder.png" 
                    alt="ARRTECH Logo" 
              ...
              <div 
                ref={aiPlaygroundRef}
                className="w-full max-w-[340px] rounded-2xl border border-slate-200/70 bg-white p-3 shadow-lg flex flex-col min-h-[240px] relative hover:-translate-y-1.5 hover:shadow-2xl transition-all duration-300 mx-auto"
              >
