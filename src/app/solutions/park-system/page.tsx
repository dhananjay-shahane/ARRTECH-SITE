...
import { 
  ArrowRight, Ticket, Waves, CreditCard, Users,
  BarChart3, Clock, Shield, Smartphone
} from 'lucide-react';

// Core Modules
const coreModules = [
  { icon: Ticket, name: 'Ticketing & Entry', desc: 'Online booking, QR tickets, turnstile integration' },
  { icon: CreditCard, name: 'Cashless Payments', desc: 'RFID wristbands, wallet top-up, POS sync' },
  { icon: Users, name: 'Locker Management', desc: 'RFID lockers, key allocation, deposit tracking' },
  { icon: BarChart3, name: 'Revenue Analytics', desc: 'Real-time sales, footfall, zone heatmaps' }
];

// RFID Wristband Features
const wristbandFeatures = [
  { name: 'Entry Access', desc: 'Tap-to-enter at rides & zones' },
  { name: 'Cashless Wallet', desc: 'Food, merchandise, rentals' },
  { name: 'Locker Key', desc: 'No physical keys needed' },
  { name: 'Photo Linking', desc: 'Ride photos auto-linked' }
];

// Park Types
const parkTypes = [
  { name: 'Water Parks', capacity: '500-10,000 guests/day', features: ['Slide tracking', 'Locker zones', 'Cabana booking'] },
  { name: 'Amusement Parks', capacity: '1,000-50,000 guests/day', features: ['Ride queues', 'Fast pass', 'Zone access'] },
  { name: 'Resorts & Clubs', capacity: 'Member-based', features: ['Membership cards', 'F&B billing', 'Facility booking'] }
];
...
export default function ParkSystemPage() {
  const pageTitle = 'Water & Amusement Park System';
          ...
          <main className="w-full lg:w-3/4 order-1 lg:order-2">
            ...
            >
              <motion.div style={{ y: heroY }} className="absolute inset-0">
                <img 
                  src="https://images.unsplash.com/photo-1605904437890-18e42e1f6e38?q=80&w=2070&auto=format&fit=crop" 
                  alt="Water & Amusement Park System"
              ...
              >
                ...
                >
                  Water & Amusement<br />
                  <span className="text-ids-blue">Park System</span>
                </motion.h1>
                <motion.p 
                ...
                >
                  RFID wristband-based ticketing, cashless payments, and locker management for theme parks and water parks.
                </motion.p>
                <motion.div
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
            ...
            >
              <motion.div variants={fadeInUp} className="flex items-center gap-3 mb-4">
                ...
                <span className="text-ids-orange font-medium">Wristbands</span>
              </motion.div>
              <motion.h2 variants={fadeInUp} className="text-3xl md:text-4xl font-bold mb-10">
                RFID Wristband Features
              </motion.h2>
                ...
                {wristbandFeatures.map((feat, i) => (
                  ...
                  >
                    <div className="flex items-center gap-3 mb-2">
                      <Smartphone className="text-ids-orange" size={18} />
              ...
              <motion.div variants={staggerContainer} className="grid md:grid-cols-3 gap-6">
                {parkTypes.map((type, i) => (
                  ...
                  >
                    ...
                    <p className="text-ids-blue text-sm mb-3">{type.capacity}</p>
            ...
            >
              ...
              <div className="relative z-10">
                <h3 className="text-2xl md:text-3xl font-bold mb-4">Go Cashless at Your Park</h3>
                <p className="text-gray-300 mb-8 max-w-2xl">
                  Implement RFID wristbands for seamless guest experience with cashless payments, locker access, and real-time analytics.
                </p>
                <div className="flex flex-wrap gap-4">
                  ...
                  <Link href="/solutions/race-management" className="bg-transparent border border-white/20 text-white font-bold px-8 py-3 rounded-full hover:bg-white/10 transition-colors">
                    Race Timing Systems
                  </Link>
                </div>
              </div>
